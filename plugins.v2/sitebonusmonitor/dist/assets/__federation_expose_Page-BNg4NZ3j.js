...
import { f as formatHourlyBonus, a as formatTb, u as unwrapResponse } from './provider-nhLRPrSl.js';
...
const _hoisted_1 = { class: "sitebonus-page-wrapper" };
const _hoisted_2 = { class: "sitebonus-app-page" };
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createVNode(_component_VToolbar, {
      ...
      default: _withCtx(() => [
        _cache[5] || (_cache[5] = _createElementVNode("div", { class: "text-h6 ms-3" }, "📊 站点魔力值监控", -1)),
    ...
    _createElementVNode("div", _hoisted_2, [
      ...
      _createVNode(_component_VSnackbar, {
        ...
        "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((testMessage).value = $event)),
        timeout: 3000,
        location: "top",
        color: "primary"
      }, {
      ...
      _createElementVNode("div", _hoisted_3, [
        _createVNode(_component_VCard, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_VCardText, { class: "d-flex flex-column summary-text" }, {
              default: _withCtx(() => [
                _cache[6] || (_cache[6] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "启用站点", -1)),
                _createElementVNode("div", _hoisted_4, _toDisplayString(summary.value.sites), 1),
                _cache[7] || (_cache[7] = _createElementVNode("div", { class: "mt-auto text-caption text-medium-emphasis summary-sub" }, " ", -1))
              ]),
              _: 1
            })
          ]),
        ...
        _createVNode(_component_VCard, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_VCardText, { class: "d-flex flex-column summary-text" }, {
              default: _withCtx(() => [
                _cache[8] || (_cache[8] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "总魔力值", -1)),
        ...
        _createVNode(_component_VCard, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_VCardText, { class: "d-flex flex-column summary-text" }, {
              default: _withCtx(() => [
                _cache[9] || (_cache[9] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "总做种数", -1)),
                _createElementVNode("div", _hoisted_7, _toDisplayString(summary.value.seeding), 1),
                _cache[10] || (_cache[10] = _createElementVNode("div", { class: "mt-auto text-caption text-medium-emphasis summary-sub" }, "活跃种子总数", -1))
              ]),
              _: 1
            })
          ]),
        ...
        _createVNode(_component_VCard, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_VCardText, { class: "d-flex flex-column summary-text" }, {
              default: _withCtx(() => [
                _cache[11] || (_cache[11] = _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "总时魔 (24h)", -1)),
      ...
      _createVNode(_component_VAlert, {
        ...
        default: _withCtx(() => [...(_cache[12] || (_cache[12] = [
          _createTextVNode(" 时魔 = 最近 24 小时内最早与最新魔力值快照的差值 / 小时数；点击表头切换排序。 ", -1)
        ]))]),
        _: 1
      }),
...
const Page = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-213bcfcc"]]);
